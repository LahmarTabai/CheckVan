<div class="container py-4">
    ...
    <form wire:submit.prevent="prendreEnCharge">
        ...
        <div class="mb-3">
            ...
            @error('photo_avant') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
    ...
    <p><strong>Véhicule :</strong> {{ $affectation->vehicule->marque }} - {{ $affectation->vehicule->immatriculation }}
    </p>
