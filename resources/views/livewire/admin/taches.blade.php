        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-sm btn-success" wire:click="valider({{ $tache->id }})">Valider</button>
                    @endif
                    <button class="btn btn-sm btn-warning" wire:click="edit({{ $tache->id }})">Modifier</button>
                    <button class="btn btn-sm btn-danger" wire:click="delete({{ $tache->id }})">Supprimer</button>
                </td>
            </tr>
            @empty
            <tr>
